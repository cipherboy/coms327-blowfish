...
blowfish::blowfish(char* key_data, int key_length)
{
    ...
    for (i = 0; i < 256; i++) {
        this->sboxes[0][i] = init_sbox_0[i];
    }
    for (i = 0; i < 256; i++) {
        this->sboxes[1][i] = init_sbox_1[i];
    }
    for (i = 0; i < 256; i++) {
        this->sboxes[2][i] = init_sbox_2[i];
    }
    for (i = 0; i < 256; i++) {
        this->sboxes[3][i] = init_sbox_3[i];
    }
